...
import OTP_B from "../../assets/Otp_B.svg";
        ...
        <div className="flex w-fit h-fit ltr mt-20 justify-center">
          ...
          >
            ...
            <OtpInput
              ...
              inputType="tel"
              inputStyle={
                "flex md:h-[43px] sm:h-[46px] h-[30px] md:scale-135 sm:scale-135 scale-200 font-[vazirmatn] font-normal md:text-[33px] sm:text-[33px] text-[24px] text-black text-center bg-gray-300 rounded-[18px] border-2 border-gray-300 transition-all ease-in-out duration-300 shadow-md focus:outline-none focus:border-blue-500 focus:bg-white focus:shadow-lg md:mx-[15px] sm:mx-[15px] mx-[17px]"
              }
