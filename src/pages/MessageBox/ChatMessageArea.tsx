        ...
        <div className="space-y-3 flex-1">
          {chatList.map((chat) => (
            <motion.div
              ...
              className={`flex items-center py-3 px-4 cursor-pointer rounded-xl transition-all overflow-x-hidden duration-300 ${selectedChat?.id === chat.id ? "bg-blue-50 dark:bg-blue-800/40 shadow-md" : "bg-white dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-blue-800/30"}`}
                ...
                <motion.div
                  ...
                  className={`max-w-[70%] mb-4 p-3 rounded-2xl text-sm leading-relaxed shadow-md transition-all duration-300 ${
                    message.type === "received"
                      ...
                      : "bg-[#2466d7] dark:bg-blue-700 text-white ml-auto rounded-tr-none"
                  }`}
                >
        ...
        <div className="sticky bottom-0 mt-3 px-5 pb-5">
          <div className="flex items-center bg-gray-50 dark:bg-gray-800 rounded-full border-2 border-blue-600 dark:border-blue-700 p-2 shadow-lg">
            <input
              ...
              className="flex-1 border-none outline-none text-sm px-4 bg-transparent placeholder-gray-500 dark:placeholder-gray-400 text-black dark:text-gray-100 transition-all duration-300"
            />
            <motion.button
              onClick={handleSendMessage}
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              className="cursor-pointer bg-blue-600 dark:bg-blue-700 text-white rounded-full p-2 hover:shadow-lg transition-all duration-300"
            >
              <svg
