    ...
    <div className="flex flex-col w-full max-w-5xl sm:my-0 mt-10 md:my-8 px-4 py-8 md:px-0 bg-white dark:bg-gray-700 dark:border-gray-800 rounded-3xl shadow-lg gap-8">
      ...
      <div className="flex flex-col gap-4 px-4">
        {[1, 2].map((i) => (
          ...
          >
            <span className="shiny-skeleton w-24 h-4 rounded mb-1 !bg-gray-200" />
            <span className="shiny-skeleton w-20 h-3 rounded mb-1 !bg-gray-200" />
            <div className="flex gap-2 mt-2">
              <span className="shiny-skeleton w-12 h-4 rounded-full !bg-gray-200" />
              <span className="shiny-skeleton w-16 h-4 rounded-full !bg-gray-200" />
            </div>
          </div>
        ))}
        {[1, 2].map((i) => (
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-800">
      ...
      <div className="flex flex-col items-center w-full min-h-screen">
        ...
        {isLoading ? (
          ...
          <main className="flex flex-col w-full max-w-5xl sm:my-0 mt-10 md:my-8 px-4 py-8 md:px-0 bg-white dark:bg-gray-700 dark:border-gray-800 border rounded-3xl shadow-lg">
