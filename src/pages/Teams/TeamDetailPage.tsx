...
const TeamDetailPage: React.FC = () => {
    ...
    return (
      <Layout>
        <div className="text-center py-10">
          ...
          <Link to="/teams" className="mt-4 inline-block bg-blue-500 text-white py-2 px-4 rounded">
            بازگشت به صفحه تیم
          </Link>
        </div>
      </Layout>
  ...
  const handleDeleteMember = (userId: string) => {
    const updatedMembers = teamData.members.filter(member => member.id !== userId);
    ...
    <Layout>
      <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
        <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
          ...
          <h1 className="text-2xl font-bold text-right order-first md:order-last">{teamData.name}</h1>
        </div>
        
        <div className="text-right mb-8">
          <p className="text-gray-700">
            {teamData.description || 'توسعه‌دهنده با تجربه وب و موبایل با بیش از 5 سال سابقه در طراحی و پیاده‌سازی وب‌سایت‌ها و اپلیکیشن‌های موبایل. تخصص اصلی من در فریم‌ورک‌های React و Next.js است و همچنین تجربه کار با Node.js و TypeScript را دارم. همواره به دنبال یادگیری تکنولوژی‌های جدید و بهبود مهارت‌های خود هستم.'}
          </p>
        </div>
        ...
        {activeTab === 'members' && (
          <div className="mb-6">
            ...
            <p className="text-gray-600 text-right mb-6">مدیریت تیم و تقسیم نقش ها بین کاربران</p>
        ...
        {activeTab === 'projects' && (
          <div className="mb-6">
            ...
            <p className="text-gray-600 text-right mb-6">پروژه های در حال انجام و اتمام شده</p>
            ...
            <div className="border rounded-lg overflow-hidden p-8 text-center">
              ...
              <p className="mt-4 text-gray-600">هیچ پروژه ای برای این تیم ثبت نشده است</p>
