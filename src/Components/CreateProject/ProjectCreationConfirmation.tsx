  ...
  return (
    <>
      ...
      <div className="container w-screen mx-auto md:px-4 sm:px-4 px-0 py-8 mt-15 lg:max-w-4xl dark:bg-gray-800">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 text-center transition-all duration-400 md:scale-100 sm:scale-[90%] scale-[85%]">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4 mt-6">
            <button
              ...
              className="flex items-center justify-center bg-blue-500 dark:bg-blue-700 text-white px-6 py-3 rounded-md hover:bg-blue-600 dark:hover:bg-blue-800 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center justify-center bg-green-500 dark:bg-green-700 text-white px-6 py-3 rounded-md hover:bg-green-600 dark:hover:bg-green-800 transition-colors"
            >
              ساخت پروژه جدید
            </button>
          </div>
