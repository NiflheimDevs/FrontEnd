      ...
      <nav className="flex flex-col justify-between h-full">
        <div className="mt-5 space-y-5 w-full items-center">
          ...
          <div className="relative">
            ...
            {isProfileOpen && isHovered && (
              <div className="absolute right-0 mt-2 w-48 bg-gray-200 rounded-lg shadow-lg z-50">
                ...
                >
                  تغییر رمز
                  {isActive("/changepass") && <div className="absolute left-0 w-1 h-full bg-blue-700"></div>}
                </Link>
              </div>
            )}
          </div>
          ...
          >
            ...
            {isActive("/messages") && <div className="absolute left-0 w-1 h-full bg-blue-700"></div>}
          </Link>
        </div>
