...
const Wallet = () => {
  ...
  const transactions: Transaction[] = [
    ...
    },
    {
      ...
      date: "2023-10-10",
      activity: "واریز",
      description: "پروژه‌ی طراحی لوگو",
      amount: 2000,
    },
    {
      id: 4,
  ...
  const totalPages =
    Math.ceil(sortedTransactions.length / transactionsPerPage) || 1;
                    ...
                    <tr className="border-b">
                      ...
                      <th className="text-lg font-semibold py-2 relative">
                        ...
                        {isActivityFilterOpen && (
                          <div
                            ref={filterModalRef}
                            className="absolute top-full left-0 bg-white border border-gray-300 rounded-md shadow-lg z-10"
                          >
                            <button
                              onClick={() => {
