    ...
    <div className="md:w-full sm:w-8/10">
      ...
      <div className="relative w-full">
        <input 
          ...
          className={`w-full bg-[#E5E5E5] py-1.75 px-3 focus:ring-2 focus:ring-blue-400 focus:outline-none focus:bg-white hover:bg-white transition duration-200 ease-in-out rounded-[18px] my-2 placeholder-black text-right text-[20px] text-black font-[vazirmatn]${isValidIdentifier === false
      ...
      <div className="relative w-full">
        <input
          ...
          className={`w-full bg-[#E5E5E5] py-1.75 px-3 focus:ring-2 focus:ring-blue-400 focus:outline-none focus:bg-white hover:bg-white transition duration-200 ease-in-out rounded-[18px] my-2 placeholder-black text-right text-[20px] text-black font-[vazirmatn]${isValidPass === false
            ? "focus:ring-3 ring-red-500"
            : isValidPass === true
            ? "focus:ring-3 ring-green-500"
            : "focus:ring-3 ring-gray-300"
